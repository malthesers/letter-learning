  ...
  >
    ...
    <div class="flex flex-col">
      <div class="grow grid place-content-center">
        <p :style="{ color: strokeColour }" class="flex flex-row gap-2 place-content-center text-9xl font-bold duration-500">
    ...
    <div class="h-full flex flex-col mx-auto p-4 bg-slate-300 bg-opacity-70 rounded-3xl">
      ...
      <div class="max-h-[60dvh] grid grid-rows-1 grid-cols-1 *:grid-center my-auto overflow-hidden">
        ...
        <canvas
          ...
          width="1000"
          height="700"
          class="place-self-center cursor-none overflow-hidden"
